...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1540832415;
...
abstract class RustLibApi extends BaseApi {
  Stream<String> crateApiProcessApiStartProcess(
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Stream<String> crateApiProcessApiStartProcess(
    ...
    unawaited(handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        return wire.wire__crate__api__process_api__start_process(
      ...
      constMeta: kCrateApiProcessApiStartProcessConstMeta,
  ...
  TaskConstMeta get kCrateApiProcessApiStartProcessConstMeta =>
      const TaskConstMeta(
