...
#[no_mangle]
pub extern "C" fn frbgen_xfdm_wire__crate__api__process_api__start_process(
    port_: i64,
    ...
    wire__crate__api__process_api__start_process_impl(
        port_,
        executable,
        arguments,
        working_directory,
...
#[no_mangle]
pub extern "C" fn frbgen_xfdm_wire__crate__api__simple__init_app(port_: i64) {
